                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                            <h3 class="m-0">Hasil Pencarian "<?= $_GET['q'] ?>"</h3>
                        </div>
                    </div>
                    ...
                    if (count($results) === 0) {
                        ...
                        echo "<div class='col-lg-12'><p class='text-center mt-5'>Maaf tidak ada hasil pencarian untuk '" . htmlspecialchars($_GET['q']) . "'</p></div>";
